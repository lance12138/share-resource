...
<head>
 <base href="<%=basePath%>">
  ...
  <body>
  <form action="teachTeamAction_thesisbatchDelete" method="post">
   <div id="delete">
  ...
  <s:form id="thesisForm" name="thesisForm" action="teachTeamAction_thesisManage" method="post">
  ...
  <div id="spanDiv"><span id="span">研究论文管理</span></div>
  <div id="title">
 ...
 <table width="100%" border="1" cellspacing="1" cellpadding="1">
  ...
  <s:iterator id="gz" value="thesisList">
  <tr id="content">
    <td>${thesisName}</td>
    <td>${issue}</td>
    <td>${studyTime}</td>
    <td>${author}</td>
    <td>${position}</td>
    <td><a href="teachTeamAction_deleteThesis?id=${id}">删除</a></td>
  </tr>
 </s:iterator>
</table>
</s:form>
