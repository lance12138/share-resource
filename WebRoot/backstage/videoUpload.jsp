...
CourseAction.getChapterList(course,getChapter_callback)  
 ...
 window.onload=function(){
    ...
    document.getElementById("chapter").textContent="请选择章节！";
    return false;
  ...
  <tr  bgcolor="#ccccff" >  
    ...
    <td><s:select name="video.chapter" id="course_chapter" list="#{}"   
                                                    listKey="title" /><label id="chapter" class="label">${course_title}</label></td>  
  </tr>  
    <tr  bgcolor="#ccccff" >  
    <td>选择上传类型：</td>  
    <td><select name="video.grade">
    <option value=0>微视频</option>
  ...
  <tr  bgcolor="#ccccff" >  
    <td></td>  
    <td style="font-family:'微软雅黑';font-size:12px;color:red;">温馨提示：视频URL为视频原始名加上后缀名，例如：XXXX.mp4(请使用数字或者英文命名)</br>
