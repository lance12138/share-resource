...
<head>
 <base href="<%=basePath%>">
  ...
  <body>
  <form action="teachTeamAction_topicbatchDelete" method="post">
   <div id="delete">
  ...
  <s:form id="projectForm" name="projectForm" action="teachTeamAction_teachTopicManager" method="post">
  ...
  <div id="spanDiv"><span id="span">教改课题管理</span></div>
  <div id="title">
  <s:select list="#courseList" listKey="name" listValue="name" name="courseOfTopic"></s:select>
 ...
 <table width="100%" border="1" cellspacing="1" cellpadding="1">
  ...
  <s:iterator id="gz" value="topicList">
  <tr>
    <td>${projectName}</td>
    <td>${projectSource}</td>
    <td>${StartTime}</td>
    <td>${author}</td>
    <td><a href="teachTeamAction_deleteTopic?id=${id}">删除</a></td>
  </tr>
 </s:iterator>
</table>
</s:form>
