...
<head>
 <base href="<%=basePath%>">
  ...
  <tr  bgcolor="#ccccff" >
    <td width="11%">教学日历</td>
    <td><input type="file" name="calendar" id="calendar"/><label style="color:red;">* ${calendarError}</label></td>
   <td colspan="2">学习指南</td>
   <td><input type="file" name="guide" id="guide" /><label style="color:red;">* ${guideError}</label></td>
  </tr>
   <tr  bgcolor="#ccccff" >
    <td>课程学时</td>
