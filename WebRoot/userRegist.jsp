...
<div class="content">
  ...
  <s:form id="registForm" name="registForm" action="userAction_userRigest" method="post">
    	...
    	<li><label class="errorUser" id="repasswordError"></label>确认密码:<input id="repassword" name="user.repassword" placeholder="请再次输入密码" class="inputClass" type="password"  /></li><!--
    	<li>所属学院:
...
function validateUsername() {
	...
	$.ajax({
		url:"userAction_validateUserName",//要请求的actiont		
		data:{name:value},//给服务器的参数	
		type:"POST",
		dataType:"json",
