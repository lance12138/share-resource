...
<head>
 <base href="<%=basePath%>">
	<meta charset="UTF-8">	<title>在线测试</title>
...
<s:form id="questionForm" name="questionForm" action="questionAction_validateAnswer?courseid=%{courseid}" method="post" enctype="multipart/form-data">
<s:hidden id="pageSize" name="pageSize" value='5'/>
    ...
    <s:if test="#request.singleQuestionList.size!=0">
    ...
    <s:iterator id="single" value="singleQuestionList" status="st">
      ...
      <div class="questionbox">
      <s:if test="#request.multiQuestionList.size!=0">
    ...
    <s:iterator id="multi" value="multiQuestionList" status="st1">
      ...
      <div class="questionbox">
      <s:if test="#request.trueOrFalseList.size!=0">
