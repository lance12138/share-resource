...
<div class="content">
    ...
    <div class="main">
    	<s:iterator id="gz"  value="courseList">
        <div class="text_area"><s:if test="#gz.introductContent==null"><s:fielderror name="Errors"/></s:if>
                               
        <s:else><object width="700" height="600">  
            <param name="flashvars"></param>  
            <param name="allowFullScreen" value="true"></param>  
            <param name="allowscriptaccess" value="always"></param>  
            <embed  src="images/${gz.introductContent}"  menu="true" loop="true" play="true"    
