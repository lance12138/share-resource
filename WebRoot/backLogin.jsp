...
<div class="login_bg">
    ...
    <form id="backLoginForm" name="backLoginForm" action="userAction_backStageLogin" method="post">
        ...
        <ul class="input_ul">
         <label>${backError}</label>
            ...
            <div class="input_li no_margin_bottom">验证码:
            	 <label><a href="javascript:change_photo();">换一张</a></label>
            	<img alt="验证码" src="/ShareResource/VerifyCodeServlet" id="imgVerifyCode" width=60 height=30>
	           
            	<input class="inputClass verification_code" id="code" type="text" size="3" name="verCode"/>
    ...
    <div class="login_bottom">江西理工大学Delta工作室 联系QQ670796228 &nbsp;<a href="index.jsp">返回首页</a></div>
</div>
</body>
