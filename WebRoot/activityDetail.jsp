...
window.onload=function()
{
    ...
    <a href="activityAction_addUI" class="act">教研活动</a>
...
<div class="content">
	<div id="title">
			...
			<h5 class="h5">
				发表时间：
				<span class="span1">${ac.ac_time}</span>
			</h5>
			<h5 class="h5">
				来源/作者：
				<span class="span2">${ac.ac_author}</span>
			</h5>
		</div>
		<div id="news">
		...
		<div id="nextPage">
				...
				<div class="innerPage">
					<span>上一篇：</span>
					<a href="activityAction_edit?activity.ac_id=${preAC.ac_id}">${preAC.ac_name}</a>
				</div>
			
				<div class="innerPage">
					<span>下一篇：</span>
					<a href="activityAction_edit?activity.ac_id=${nextAC.ac_id}">${nextAC.ac_name}</a>
				</div>
