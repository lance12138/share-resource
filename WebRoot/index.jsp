...
<meta http-equiv="pragma" content="no-cache">
	...
	<meta http-equiv="keywords" content="公共课程平台 - 江西理工大学编程语言学习平台">
	<meta http-equiv="description" content="公共课程平台 - 江西理工大学编程语言学习平台">
        ...
        <div class="about_teaching_items">
            ...
            <ul>
               ...
               <s:a action="homeAction_outline?type=2">教学日历</s:a>
                <s:a action="homeAction_outline?type=6">学习指南</s:a>
