...
<div class="content">
	<div class="course_introduce">
        ...
        <ul class="right_content">
            ...
            <div class="link_btn">
                ...
                <a href="forumAction_list">互动讨论</a>
            </div>
    ...
    <div class="course_introduce_detail">
        ...
        <div class="document_link">
            ...
            <li><a href="javascript:jump('学习指南','6',${courseid},780,550);" class="doc_img"><img src="images/course_img/doc_sample.jpg" width="110" height="80" /></a><a href="#">学习指南</a></li>
        </div>
    ...
    <div class="course_unit">
        ...
        <div class="right">
        	<a href="teachTeamAction_addUI?courseid=${courseid}">教学团队>></a>
        	<h1>课程负责人</h1>
