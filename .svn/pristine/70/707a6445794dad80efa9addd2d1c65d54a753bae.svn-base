				...
				<div class="course_point">
					...
					<ul id="course_point_select">
						<s:iterator id="gz" value="ChapterVector">
							<a  href=""  onclick="getPre(${gz.id})" data-toggle="modal" data-target="#text-inputer" ><span></span>${gz.title}</a>
			...
			<div class="course_source">
				<div class="course_source_items">
					...
					<ul>
						...
						<a href="javascript:jump('学习指南','',${course.id},780,550);">学习指南</a>			
				...
				<div class="course_source_items">
					...
					<ul>
						<a href="knowledgeAction_list?courseid=${course.id}&&knowledge.chapterId=${ChapterVector[0].id}">微知识</a>
						<a href="courseAction_littleVideo?courseid=${course.id}">微视频</a>
					
					<a href="errorAnalyseAction_enterErrorAnalyse?analyse.courseId=${course.id}">错误分析</a>
				...
				<div class="course_source_items">
					...
					<ul>
						<a href="programAction_list?courseid=${course.id}">实训项目</a>
