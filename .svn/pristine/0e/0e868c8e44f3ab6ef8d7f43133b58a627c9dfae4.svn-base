...
<style>
	.content .tips{text-align:center; position:absolute; width:288px; left:330px; top:200px; height:45px;  border:2px solid #f2a1b0; background:#f6b37f; font-size:14px; line-height:20px; padding:5px 20px; font-family:"微软雅黑"; color:#FFF;border-radius:5px; -moz-border-radius:5px;}
	.content .tips strong{color:#9f84bb;}
</style>
<script>
